...
import ExamSimulationModal from "../modals/ExamSimulationModal";
      ...
      <div className="main-container">
        ...
        >
          ...
          <section className="randomly-picked-questions">
            ...
            <h5>Pitanja{'/'}zadaci ispod su nasumično odabrani. Ova simulacija predstavlja samo primjer testa ili dijela testa.</h5>
            <ol>
            ...
            {exam?.answer_validation && (
              <button className="btn-validate" onClick={handleValidate}>
                Provjeri
              </button>
            )}
            <div className="reroll">
              <button id="reroll-btn" onClick={randomizeQuestions}>
                Ponovi nasumični odabir
              </button>
              <div className="question-count-input">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setRandomQuestionsCount(e.target.valueAsNumber)
                  }
                />
              </div>
              <span>pitanja</span>
            ...
            <ol>
              {exam?.questions?.map((question, idx) => (
                <li key={generationId + "_" + idx}>
                  <QuestionRenderer
                    generationId={generationId}
                    checked={question.correct_choices || []}
                    question={question}
                    input_disabled={true}
                  />
                </li>
